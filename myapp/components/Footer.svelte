<script>
    export let copyrightText = "copyright text goes here";
</script>

<footer class="py-16 flex flex-col items-center">
    <p class="dark:text-white uppercase mb-3 font-bold opacity-60">
      {copyrightText}
    </p>
</footer>
...
const ThemeSwitcher = () => {
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl p-1" style={{display: "none"}}>
      <button
        type="button"
